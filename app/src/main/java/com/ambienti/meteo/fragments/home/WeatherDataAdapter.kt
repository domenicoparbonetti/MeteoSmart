package com.ambienti.meteo.fragments.home
...
import coil.load
import com.ambienti.meteo.data.CurrentLocation
import com.ambienti.meteo.data.CurrentWeather
import com.ambienti.meteo.data.Forecast
import com.ambienti.meteo.data.WeatherData
import com.ambienti.meteo.databinding.ItemContainerCurrentLocationBinding
import com.ambienti.meteo.databinding.ItemContainerCurrentWeatherBinding
import com.ambienti.meteo.databinding.ItemContainerForecastBinding
    ...
    inner class CurrentWeatherViewHolder(
        ...
        fun bind(currentWeather: CurrentWeather){
            with(binding){
                ...
                textRain.text= String.format("%s%%", currentWeather.chanceOfRain)
            }
        }
    }
