...
import com.ambienti.meteo.data.LiveDataEvent
...
public class HomeViewModel(private val weatherDataRepository: WeatherDataRepository) : ViewModel() {
    ...
    fun getCurrentLocation(
        ...
        viewModelScope.launch {
            ...
            weatherDataRepository.getCurrentLocation(
                ...
                onFailure = {
                    emitCurrentLocationUiState(error = "Impossibile trovare la posizione attuale")
                }
            )
        }
    }
    ...
    fun getWeatherData(latitude: Double, longitude: Double){
        viewModelScope.launch {
            ...
            } ?: emitWeatherDataUiState(error = "Impossibile recuperare i dati meto")
        }
    }
