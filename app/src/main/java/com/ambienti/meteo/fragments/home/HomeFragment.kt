...
import com.ambienti.meteo.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun showLocationOptions(){
        val options = arrayOf("Posizione attuale","Ricerca manuale")
        AlertDialog.Builder(requireContext()).apply {
            setTitle("Scegli metodo di posizione")
    ...
    private fun startManualLocationSearch(){
        ...
        findNavController().navigate(com.ambienti.meteo.R.id.action_home_fragment_to_location_fragment)
    }
